...
$(document).ready(function() {
    $(".topbar").hide();
      ...
      //hide the showpop bar and result section before searching
      /*var getEmail;
      var availableTags = [
      "Amy",
      "Berkeley",
    ...
    $("#post_btn").click(function(){
      var getEmail = $("#contactInfo").val();
      //alert(getEmail);
      var getInput = $("#post_c").val();
      
      var getGroup = $("input:radio[name=group]:checked").val();
      //alert(getInput);
      $(".topbar").fadeIn("fast",function(){
        $(".topbar").html("<p>"+getDate+" "+getEmail+" "+getGroup+"</p><p>"+getInput+"</p>");
      });
